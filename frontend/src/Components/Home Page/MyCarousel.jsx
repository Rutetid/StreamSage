					...
					{movies.map((movie, i) => (
						...
						<div key={i} className="flex-shrink-0 w-1/6 p-1  ">
							<div className="bg-gray-900 rounded-xl shadow-lg relative">
								...
								/>
								{/* <div>
									<div className="absolute bottom-0 right-0 m-2 px-1 bg-primary rounded-md font-poppins font-bold text-sm">
										Added to Watchlist!
									</div>
									<div className="absolute top-0 right-0 m-2 font-poppins font-bold text-sm bg-primary px-1 rounded-md" title="Remove from Watchlist">
										X
									</div>
								</div> */}
								<img
